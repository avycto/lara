...
@section('content')
    ...
    <div class="container my-3">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4 col-12 col-sm-12">
                <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8  col-sm-12 col-12">
                ...
                <p class="text-nowrap d-none d-lg-inline-block d-sm-none d-md-inline-block">Wouldn't you like to get away? Sometimes you want to go where everybody knows your name.</p>
                <p class="d-lg-none d-sm-inline-block d-md-none">Wouldn't you like to get away?</p>
            </div>
