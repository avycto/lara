                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-4">
                            <button type="button" class="btn btn-responsive button-alignment btn-primary my-3" id="btn1">
                                Simple Alert
                            </button>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-4">
                            <button type="button" class="btn btn-responsive button-alignment btn-success my-3" id="btn2">Some
                                Large Text
                            </button>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-4">
                            <button type="button" class="btn btn-responsive button-alignment btn-info my-3" id="btn3">Success
                                Alert
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <button type="button" class="btn btn-responsive button-alignment btn-warning my-3" id="btn4">
                                    Submit action
                                </button>
                            </div>
                            <div class="col-md-7 col-sm-6">
                                <button type="button" class="btn btn-responsive button-alignment btn-danger my-3" id="btn5">
            ...
            <div class="card panel-success">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <button type="button" class="btn btn-responsive button-alignment btn-info my-3" id="btn6">Simple
                            Image
                        </button>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <button type="button" class="btn btn-responsive button-alignment btn-success my-3" id="btn7">Simple
                            Image2
                        </button>
                    </div>
                </div>
        ...
        <div class="col-md-6 col-lg-6 col-12">
            <div class="card panel-danger">
                ...
                <div class="card-body">
                    <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <button type="button" class="btn btn-responsive button-alignment btn-warning my-3" id="btn8">Auto
                            Close
                        </button>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <button type="button" class="btn btn-responsive button-alignment btn-primary my-3" id="btn9">Ajax
                            usage
                        </button>
                    </div>
                </div>
