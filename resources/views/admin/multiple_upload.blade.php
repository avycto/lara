...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/toastr/css/toastr.css') }}" rel="stylesheet"/>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/toastr/js/toastr.js') }}"></script>
    <script src="{{ asset('assets/js/ui-toastr.js') }}"></script>
